 ...
 */
final class Version20210208091049 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE voiture (id INT AUTO_INCREMENT NOT NULL, modele_id INT DEFAULT NULL, immatriculation VARCHAR(20) NOT NULL, nb_portes INT NOT NULL, annee INT NOT NULL, image VARCHAR(255) NOT NULL, prix INT NOT NULL, INDEX IDX_E9E2810FAC14B70A (modele_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
